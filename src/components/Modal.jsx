...
export default function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm transition-all">
      <div className="bg-white rounded-2xl shadow-xl max-w-3xl w-full mx-4 p-6 relative animate-fade-in">
        <button
          onClick={onClose}
        ...
        <ul className="space-y-2 list-disc pl-5 text-gray-800 text-justify leading-relaxed">
