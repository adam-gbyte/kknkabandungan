...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-2 left-1/2 -translate-x-1/2 z-40 w-[95%] md:w-[80%] backdrop-blur-sm bg-white dark:bg-black/10 border border-white/30 shadow-xl rounded-xl px-4 py-3">
