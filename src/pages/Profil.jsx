            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  <strong>kebahagiaan</strong>, <strong>optimisme</strong>, dan{" "}
                  <strong>energi positif</strong>.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  <strong>kesegaran</strong>, <strong>kegembiraan</strong>, dan{" "}
                  <strong>kemurnian</strong>.
                </p>
              </div>
